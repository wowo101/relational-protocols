...
The inseparability of the three layers is the non-optional design feature that structurally requires the interruption of separation logic. What this inseparability stakes – and what it risks – is the subject of [[This is a wager, not a blueprint|the architecture's central wager]].
