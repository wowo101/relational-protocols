...
**Federation.** Network nodes can form a delegate [[Circles are a basic unit of shared governance|circle]] – each one selects a delegate to participate in a shared governance space where they align policies, share learning, and evolve agreements that affect all of them.
