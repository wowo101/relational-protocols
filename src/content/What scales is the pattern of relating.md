...
The protocol architecture offers an answer: what scales is not the relationship itself but the *pattern of relating*. When organisations across the network adopt the same consent protocol, they are not in direct relationship with each other – but they are practising the same decision-making discipline, developing the same capacities, and becoming interoperable. The protocol is the mechanism through which relational transformation scales beyond the dyad.

This is how we scale relationships: We form strong relationships of solidarity and connect them into larger assemblages. We can do that because they share structural properties – like cells in an organism that don't all communicate directly but are coordinated through shared chemical protocols.
