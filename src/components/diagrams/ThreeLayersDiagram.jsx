export default function ThreeLayersDiagram() {
  return (
    <svg viewBox="0 0 680 300" className="w-full my-6">
      ...
      <text x="210" y="62" textAnchor="middle" dominantBaseline="central" fontSize={14} fontWeight={500} fill="#0C447C">Accord</text>
      <text x="210" y="82" textAnchor="middle" dominantBaseline="central" fontSize={12} fill="#185FA5">What do we agree on?</text>
      <rect x="60" y="112" width="300" height="56" rx="8" fill="#EEEDFE" stroke="#534AB7" strokeWidth={0.5} />
      <text x="210" y="132" textAnchor="middle" dominantBaseline="central" fontSize={14} fontWeight={500} fill="#3C3489">Ritual</text>
      <text x="210" y="152" textAnchor="middle" dominantBaseline="central" fontSize={12} fill="#534AB7">What do we embody together?</text>
      <rect x="60" y="182" width="300" height="56" rx="8" fill="#FAECE7" stroke="#993C1D" strokeWidth={0.5} />
      <text x="210" y="202" textAnchor="middle" dominantBaseline="central" fontSize={14} fontWeight={500} fill="#712B13">Compass</text>
      ...
      <text x="410" y="52" fontSize={12} fill="var(--color-text-secondary, #5f5e5a)">Accord alone</text>
      <text x="412" y="68" fontSize={12} fill="var(--color-text-secondary, #5f5e5a)">= bureaucracy</text>
      <text x="410" y="122" fontSize={12} fill="var(--color-text-secondary, #5f5e5a)">Accord + ritual</text>
      <text x="412" y="138" fontSize={12} fill="var(--color-text-secondary, #5f5e5a)">= well-coordinated separation</text>
      <text x="410" y="192" fontSize={12} fill="var(--color-text-secondary, #5f5e5a)">Ritual alone</text>
